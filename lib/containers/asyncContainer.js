...
var asyncContainer = function asyncContainer(TypeaheadComponent) {
  var AsyncTypeahead = /*#__PURE__*/function (_React$Component) {
    function AsyncTypeahead() {
      ...
      (0, _defineProperty2["default"])(_this, "_cache", {});
      (0, _defineProperty2["default"])(_this, "_handleSearchDebounced", void 0);
      (0, _defineProperty2["default"])(_this, "_query", _this.props.defaultInputValue || '');
      (0, _defineProperty2["default"])(_this, "_getEmptyLabel", function () {
      ...
      (0, _defineProperty2["default"])(_this, "_handleInputChange", function (query, e) {
        _this.props.onInputChange && _this.props.onInputChange(query, e);
        _this._handleSearchDebounced(query);
      });
      (0, _defineProperty2["default"])(_this, "_handleSearch", function (query) {
        _this._query = query;
