...
function getMatchBounds(subject, str) {
  const search = new RegExp(escapeStringRegexp((0, _stripDiacritics.default)(str)), CASE_INSENSITIVE);
  const matches = search.exec((0, _stripDiacritics.default)(subject));
  if (!matches) {
    return null;
  }
