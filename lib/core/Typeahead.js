...
var Typeahead = /*#__PURE__*/function (_React$Component) {
  function Typeahead() {
    ...
    (0, _defineProperty2["default"])(_this, "state", getInitialState(_this.props));
    (0, _defineProperty2["default"])(_this, "inputNode", void 0);
    (0, _defineProperty2["default"])(_this, "isMenuShown", false);
    // Keeps track of actual items displayed in the menu, after sorting,
    // truncating, grouping, etc.
    (0, _defineProperty2["default"])(_this, "items", []);
    ...
    (0, _defineProperty2["default"])(_this, "getInput", function () {
      return _this.inputNode;
    });
    /**
     * For backwards compatibility...
     */
    (0, _defineProperty2["default"])(_this, "getInstance", function () {
      (0, _utils.warn)(false, 'The `getInstance` method is deprecated. You can now access instance ' + 'methods directly on the ref.');
      return _this;
    });
    (0, _defineProperty2["default"])(_this, "inputRef", function (inputNode) {
      _this.inputNode = inputNode;
    });
    (0, _defineProperty2["default"])(_this, "setItem", function (item, position) {
      _this.items[position] = item;
    });
    (0, _defineProperty2["default"])(_this, "hideMenu", function () {
      _this.setState(hideMenu);
    });
    (0, _defineProperty2["default"])(_this, "toggleMenu", function () {
      _this.setState(toggleMenu);
    });
    (0, _defineProperty2["default"])(_this, "_handleActiveIndexChange", function (activeIndex) {
    ...
    (0, _defineProperty2["default"])(_this, "_handleActiveItemChange", function (activeItem) {
    ...
    (0, _defineProperty2["default"])(_this, "_handleBlur", function (e) {
      e.persist();
      _this.setState({
        isFocused: false
      }, function () {
    ...
    (0, _defineProperty2["default"])(_this, "_handleChange", function (selected) {
      _this.props.onChange && _this.props.onChange(selected);
    });
    (0, _defineProperty2["default"])(_this, "_handleClear", function () {
      _this.setState(clearTypeahead, function () {
        return _this._handleChange([]);
      });
    });
    (0, _defineProperty2["default"])(_this, "_handleFocus", function (e) {
      e.persist();
      _this.setState({
        isFocused: true,
        showMenu: true
    ...
    (0, _defineProperty2["default"])(_this, "_handleInitialItemChange", function (initialItem) {
    ...
    (0, _defineProperty2["default"])(_this, "_handleInputChange", function (e) {
      e.persist();
    ...
    (0, _defineProperty2["default"])(_this, "_handleKeyDown", function (e) {
    ...
    (0, _defineProperty2["default"])(_this, "_handleMenuItemSelect", function (option, e) {
    ...
    (0, _defineProperty2["default"])(_this, "_handlePaginate", function (e) {
      e.persist();
      _this.setState(function (state, props) {
        return {
    ...
    (0, _defineProperty2["default"])(_this, "_handleSelectionAdd", function (option) {
    ...
    (0, _defineProperty2["default"])(_this, "_handleSelectionRemove", function (selection) {
